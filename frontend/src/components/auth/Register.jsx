        ...
        <div className="w-full max-w-md">
          <div className="bg-white/80 backdrop-blur-xl border border-white/60 rounded-3xl p-5 sm:p-8 shadow-2xl animate-slide-up">
            <div className="text-center mb-6 sm:mb-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-1 sm:mb-2">Join BlinkMe</h2>
            ...
            <form onSubmit={handleRegister} className="space-y-4 sm:space-y-6">
              <div className="relative">
                ...
                <div className="relative">
                  <input
                    type="text"
                    className="w-full px-3 py-3 sm:px-4 sm:py-4 pl-10 sm:pl-12 bg-gray-50/50 border border-gray-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all duration-300 text-gray-800 placeholder-gray-500 text-sm sm:text-base"
              ...
              <div className="relative">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-3 py-3 sm:px-4 sm:py-4 pl-10 sm:pl-12 pr-10 sm:pr-12 bg-gray-50/50 border border-gray-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all duration-300 text-gray-800 placeholder-gray-500 text-sm sm:text-base"
              ...
              <div className="flex items-start gap-2 sm:gap-3">
                <input
                  ...
                  className="w-4 h-4 text-emerald-600 rounded focus:ring-emerald-500 border-gray-300 mt-0.5"
                />
              ...
              <div className="text-center pt-3 sm:pt-4">
                ...
                <button
                  ...
                  className="text-xs sm:text-sm text-emerald-600 hover:text-emerald-700 font-semibold transition-colors"
                >
                  Sign in here
                </button>
              </div>
